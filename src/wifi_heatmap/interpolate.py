"""Кластеризация точек и интерполяция сигнала на регулярную сетку (IDW)."""
...
class Interpolator(Protocol):
    """Точка расширения под альтернативный метод интерполяции (например, Kriging)."""
...
def idw_grid(
    ...
    *,
    ...
    Если не передан, маска считается от самих точек замеров (режим mask_mode=points).
    """
